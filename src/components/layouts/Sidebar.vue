      	...
      	<div class="left main-sidebar">
	        ...
	        <div class="sidebar-inner leftscroll">
	          ...
	          <ul>
	              	...
	              	<li class="submenu">
	                	<router-link to="/" class="active"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </router-link>
	                </li>

	              	<li class="submenu">
	                    <router-link to="/chart"><i class="fa fa-fw fa-area-chart"></i><span> Charts </span> </router-link>
	                </li>
