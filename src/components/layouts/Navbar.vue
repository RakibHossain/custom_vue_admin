	...
	<div>
        ...
        <div class="headerbar">
            ...
            <div class="headerbar-left">
                <router-link to="/" class="logo"><img alt="Logo" :src="`${publicPath}assets/images/logo.png`" /> <span>Admin</span></router-link>
            </div>
            ...
            <nav class="navbar-custom">
                ...
                <ul class="list-inline menu-left mb-0">
                    <li class="float-left">
                        <button class="button-menu-mobile open-left" v-bind:class="{'adminbody-void': isActive}" @click="isActive = !isActive">
